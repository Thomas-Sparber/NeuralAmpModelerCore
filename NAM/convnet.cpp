...
void nam::convnet::ConvNet::process(const NAM_SAMPLE* input, NAM_SAMPLE* output, const int num_frames)
...
void nam::convnet::ConvNet::_update_buffers_(const NAM_SAMPLE* input, const int num_frames)
{
