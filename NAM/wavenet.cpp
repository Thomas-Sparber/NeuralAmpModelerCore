...
void nam::wavenet::WaveNet::_set_condition_array(const NAM_SAMPLE* input, const int num_frames)
{
...
void nam::wavenet::WaveNet::process(const NAM_SAMPLE* input, NAM_SAMPLE* output, const int num_frames)
{
